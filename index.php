        ...
        <div class="col-8 mx-auto">
          <div id="accordion">
            <div class="card">
              ...
              <div id="financeAccount" class="collapse <?php
              is_collapsed('account-index'); ?>" aria-labelledby="headingFinanceAccount" data-parent="#accordion">
                <div class="card-body">
                    <?php
            ...
            <div class="card">
              ...
              <div id="financeAccountCreate" class="collapse <?php
              is_collapsed('account-create'); ?>" aria-labelledby="headingFinanceAccountCreate" data-parent="#accordion">
                <div class="card-body">
                    <?php
            ...
            <div class="card">
              ...
              <div id="financeAccountShow" class="collapse <?php
              is_collapsed('account-show'); ?>" aria-labelledby="headingFinanceAccountShow" data-parent="#accordion">
                <div class="card-body">
                    <?php
            ...
            <div class="card">
              ...
              <div id="financeAccountUpdate" class="collapse <?php
              is_collapsed('account-update'); ?>" aria-labelledby="headingFinanceAccountUpdate" data-parent="#accordion">
                <div class="card-body">
                    <?php
            ...
            <div class="card">
              ...
              <div id="financeAccountDelete" class="collapse <?php
              is_collapsed('account-delete'); ?>" aria-labelledby="headingFinanceAccountDelete" data-parent="#accordion">
                <div class="card-body">
                    <?php
